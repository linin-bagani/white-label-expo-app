      ...
      <Animated.View
        ...
        <TextClassContext.Provider value="text-sm native:text-base text-popover-foreground">
          <TooltipPrimitive.Content
            ...
            className={cn(
              'z-50 rounded-xl border border-[#71717A] p-4 web:animate-in web:fade-in-0 web:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 bg-[#71717A]',
              className,
            )}
            {...props}
          />
