...
// https://gitlab.com/catamphetamine/country-flag-icons/-/blob/master/source/countries.json.js?ref_type=heads
// https://unpkg.com/country-flag-icons/1x1/flags.css
// https://unpkg.com/country-flag-icons/3x2/flags.css
// https://www.npmjs.com/package/country-flag-icons
// Flag CSS are saved in packages/ui/css/flags.css
export type Flag = {
  name: string;
  flag: string;
  code: string;
...
const data: Flag[] = [
  ...
  { name: 'Haiti', flag: '🇭🇹', code: 'HT', dialCode: 509 },
  {
    ...
    code: 'AU',
    dialCode: 672,
  }, // https://vexillology.fandom.com/wiki/Heard_Island_and_McDonald_Islands Heard Island and McDonald Islands is an uninhabited external territory of Australia in the southern Indian Ocean. It does not have a flag.
  {
